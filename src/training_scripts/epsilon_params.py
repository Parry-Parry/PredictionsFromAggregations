...
def main(args):
    ...
    for partit in PARTITIONS:
        ...
        if args.partitions == 1:
            ...
            mean, shape, dataset = aggregate(dataset, partit, args.partition_path, args.seed)
        ...
        for n in N_GEN:
            ...
            config = generator_config((BATCH_SIZE, b, c, d), n, n_classes, 4, intermediate, None)
            for epsilon in EPSILON:
                model = n_epsilon_model(config, epsilon)
                ...
                with open(args.dir + "/{}epsilon{}generator{}partitions{}.pkl".format(epsilon, args.dataset, n, partit), 'wb') as file:
